	...
	public Data_Clientes() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			}
			{
				...
				cbxCarrera.setModel(new DefaultComboBoxModel(new String[] {"<Seleccione su carrera>", "Direccion Empresarial", "Administracion Hotelera", "Arquitectura", "Comunicacion Social", "Derecho", "Diseño", "Interiorismo", "Ecologia y Gestion Ambiental", "Economia", "Educacion", "Estomatologia", "Filosofia", "Gestion Financiera", "Editorial", "Ingenieria Civil", "Ingenieria Mecanica", "Ingenieria Electrica", "Ingenieria Industrial", "Ingenieria Mecatronica", "Ingenieria en Sistemas y Computacion", "Ingenieria Telematica", "Medicina", "Marketing", "Nutricion y Dietetica", "Psicologia", "Terapia", "Fisica", "Trabajo Social"}));
				...
				JButton btnAgregarA = new JButton("Agregar otra Area");
